    ...
    public int[] solution(String[] genres, int[] plays) {
        ...
        while (iteratorKey.hasNext()) {
            ...
            while (it2.hasNext()) {
                ...
                System.out.println(genreMap.get(genreIndex));
                System.out.println(hashMap.get(index));
                if (genreMap.get(genreIndex).equals(hashMap.get(index))) {
//                    System.out.println(howToManyPlayMap.get(genreIndex));
            ...
            for (int i = 0; i < 2; i++) { // 최대 2개까지만 넣는다
        ...
        for (int i = 0; i < answerPlayTimeList.size(); i++) {
            ...
            while (it3.hasNext()) {
                int n = (int) it3.next();
                if (howToManyPlayMap.get(n).equals(answerPlayTimeList.get(i))) {
